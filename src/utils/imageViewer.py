"""Simple Streamlit image viewer for quick dataset inspection.

Why: Some datasets are too large to browse comfortably with the file manager.
This app lets you page through images to inspect them quickly.
"""
...
def load_images(directory):
    """Return sorted list of image filenames if directory exists."""
